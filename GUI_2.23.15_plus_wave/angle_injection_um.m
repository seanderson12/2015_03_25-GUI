...
% s=serial(com_name,'BaudRate',19200);
% fopen(s); set(s, 'TimeOut', 0.02);
% actionmeter_1 = ['C007 ',outputp1_1,' ',outputp1_2,' ',outputp1_3,' ',outputv1_1,' ',outputv1_2,' ',outputv1_3];
...
%         if     strcmpi(info_m_1_cut{1},'A007')  &&       strcmpi(info_m_1_cut{2},'0') % compare the char, ignore case
%             1;
%             
%         elseif strcmpi(info_m_1_cut{1},'A007')  &&       strcmpi(info_m_1_cut{2},'1')
%             set(hFeedback,'string','STOPPED for hitting z upper limit ');
%                  
%         elseif strcmpi(info_m_1_cut{1},'A007')  &&       strcmpi(info_m_1_cut{2},'2')
%             set(hFeedback,'string','STOPPED for hitting z lower limit ');
%                  
%         elseif strcmpi(info_m_1_cut{1},'A007')  &&  8>str2double(info_m_1_cut{2}) && str2double(info_m_1_cut{2}) >=4
%             set(hFeedback,'string','STOPPED for hitting y lower limit ');
%                  
%         elseif strcmpi(info_m_1_cut{1},'A007')  && 16>str2double(info_m_1_cut{2}) && str2double(info_m_1_cut{2}) >=8
%             set(hFeedback,'string','STOPPED for hitting y upper limit ');   
%                        
%         elseif strcmpi(info_m_1_cut{1},'A007')  && 32>str2double(info_m_1_cut{2}) && str2double(info_m_1_cut{2}) >=16
%             set(hFeedback,'string','STOPPED for hitting x upper limit '); 
%                  
%         elseif strcmpi(info_m_1_cut{1},'A007')  &&    str2double(info_m_1_cut{2}) >= 32
